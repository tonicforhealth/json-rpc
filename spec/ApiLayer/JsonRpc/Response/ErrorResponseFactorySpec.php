...
class ErrorResponseFactorySpec extends ObjectBehavior
{
    ...
    function it_should_return_appropriate_response_for_parse_exception()
    {
        $this
    ...
    function it_should_return_appropriate_response_for_invalid_request_exception()
    {
        $this
    ...
    function it_should_return_appropriate_response_for_invalid_params_for_indexed_array()
    {
        $this
    ...
    function it_should_return_method_not_found_error()
    {
        $this
    ...
    function it_should_return_appropriate_response_for_invalid_params_for_any_other_problem()
    {
        $this
    ...
    function it_should_return_application_defined_error()
    {
        $this
    ...
    function it_should_return_application_error_for_any_other_error()
    {
        $this
    ...
    function it_should_have_ability_to_expose_internal_exceptions()
    {
