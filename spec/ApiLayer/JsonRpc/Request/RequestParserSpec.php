...
class RequestParserSpec extends ObjectBehavior
{
    ...
    public function it_should_parse_json_and_create_request_object()
    {
        $this
    ...
    public function it_should_throw_exception_for_invalid_json()
    {
        $this
    ...
    public function it_should_throw_exception_for_invalid_request_without_protocol_version()
    {
        $this
    ...
    public function it_should_throw_exception_for_invalid_request_without_method()
    {
        $this
            ->shouldThrow(InvalidRequestException::class)
    ...
    public function it_should_throw_exception_for_invalid_request_without_params()
    {
        $this
            ->shouldThrow(InvalidRequestException::class)
    ...
    public function it_should_throw_exception_for_invalid_request_without_id()
    {
        $this
            ->shouldThrow(InvalidRequestException::class)
    ...
    public function it_should_throw_exception_for_invalid_request_with_invalid_params()
    {
        $this
            ->shouldThrow(InvalidRequestException::class)
