...
class NormalizerSpec extends ObjectBehavior
{
    ...
    function it_should_map_complex_object_to_array()
    {
        $this
    ...
    function it_should_map_simple_array_to_specified_simple_object()
    {
        $this
    ...
    function it_should_map_complex_array_to_complex_object()
    {
        $this
